...
Public Class tcpConnection
    Public Enum RequestTags As Byte
        Connect = 1
        Disconnect = 2
        DataTransfer = 3
        StringTransfer = 4
    ...
    Public isConnected As Boolean 'set to true when connection is granted by server
                ...
                Case RequestTags.Connect
                    ...
                    SyncLock client.GetStream
                        ...
                        Catch ex As Exception
                            MessageBox.Show("Siamo stati dsiconnessi da Asc Exchange, errore: " & ex.Message, "Server Message")
                            client.Close()
                            Exit Sub
                        End Try
