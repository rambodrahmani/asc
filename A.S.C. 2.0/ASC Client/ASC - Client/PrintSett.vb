Public Class PrintSett
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If CheckBox1.Checked = True Then
            ...
            MsgBox("Preferenze stampa memorizzate correttemente, da quetso momento in poi usa il MainMenu alla voce 'Modifica' per modificare le tue preferenze.", MsgBoxStyle.Information, "Asc Client - Preferenze Stampa")
        Else
            My.Settings.Top = TextBox1.Text
            My.Settings.Left = TextBox2.Text
            My.Settings.Width = TextBox3.Text
