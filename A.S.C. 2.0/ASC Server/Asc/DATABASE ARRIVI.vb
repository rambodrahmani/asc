    ...
    Public Sub UseMessage()
        ...
        Try
            For Each cell In DataGridView1.SelectedCells
                ...
                leggi = System.IO.File.OpenText(Application.StartupPath & "\Email\DATABASEARRIVI\" & datadefinitiva(0) & "\emailinviate" & (cell.RowIndex + 1).ToString("D4") & "A.txt")
        ...
        If My.Settings.SelectedDate2 <> "" Then
            Try
                If System.IO.File.Exists(Application.StartupPath & "\Email\DATABASEARRIVI\" & My.Settings.SelectedDate2 & "\datiemailinviate" & My.Settings.SelectedDate2 & ".txt") Then
                    ...
                    LoadNr()
                ElseIf letto = "" Then
                    MsgBox("Non sono state inviate email, nella data selezionata, da visualizzare!", MsgBoxStyle.Information, "Asc Server - Database Arrivi")
                End If
            Catch ex As Exception
    ...
    Public Sub cercaemail()
        ...
        Try
            For Each cell In DataGridView1.SelectedCells
                ...
                My.Settings.OpenedFilePath = Application.StartupPath & "\Email\DATABASEARRIVI\" & datadefinitiva(0) & "\emailinviate" & (cell.RowIndex + 1).ToString("D4") & "A.txt"
                MessageText.Show()
            Next
        Catch ex As Exception
                ...
                If AlertMessage = 6 Then
                    ...
                    For Each cell In DataGridView1.SelectedCells
                        If cell.Value.ToString <> "" Then
                            System.IO.File.Delete(Application.StartupPath & "\Email\DATABASEARRIVI\" & datagiorno & "\emailinviate" & (cell.RowIndex + 1).ToString("D4") & "A.txt")
                    ...
                    For r = 0 To DataGridView1.Rows.Count - 4
                        ...
                        stringadefinitiva += My.Settings.NumEmail.ToString("D4") & "A - " & My.Settings.JlDate.ToString("D3") & "#"
                    ...
                    For z = 1 To UBound(FilesCollection2)
                        My.Computer.FileSystem.RenameFile(FilesCollection2(z), "emailinviate" & z.ToString("D4") & "A.txt")
                    Next
