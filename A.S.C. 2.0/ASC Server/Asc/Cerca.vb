...
Public Class Cerca
    ...
    Public Sub CheckRequirements()
        ...
        Try
            If TextBox1.Text = "" Then
                MsgBox("Scrivi il testo da cercare.", MsgBoxStyle.Information, "Asc Server - Ricerca")
                Exit Sub
            End If

            If ComboBox1.SelectedItem.ToString = "" Then
                MsgBox("Selezionare la modalità di ricerca.", MsgBoxStyle.Information, "Asc Server - Ricerca")
                Exit Sub
            End If

            If DTBArrivi = 0 And DTBPartenze = 0 And DTBIntelligence = 0 Then
                MsgBox("Selezionare almeno un database in cui cercare.", MsgBoxStyle.Information, "Asc Server - Ricerca")
                Exit Sub
            End If
        ...
        Catch ex As Exception
            MsgBox("Errore durante il processo di ricerca, messaggio errore: " & ex.Message, MsgBoxStyle.Information, "Asc Server - Errore Ricerca")
        End Try
    ...
    Public Sub SearchDTBArrivi()
        ...
        Try
            If ComboBox1.SelectedItem.ToString = "Ricerca Giornaliera" Then
                ...
                Try
                    For r = 1 To x
                        leggi = System.IO.File.OpenText(Application.StartupPath & "\Email\DATABASEARRIVI\" & datadacercare & "\emailinviate" & r.ToString("D4") & "A.txt")
            ...
            ElseIf ComboBox1.SelectedItem.ToString = "Ricerca Mensile" Then
                If ListView1.SelectedItems.Count > 0 Then
                        ...
                        For r = 0 To UBound(DirectoryCollection)
                            ...
                            If MySplitter(1).ToString = SelectedMonthNumber Then
                                ...
                                For z = 0 To UBound(FilesCollection)
                                    If FilesCollection(z).ToString.Contains("datiemailinviate") Then
                                    Else
                    ...
                    End If
                Else
                    MsgBox("Selezionare il mese in cui cercare.", MsgBoxStyle.Information, "Asc Server - Ricerca")
                    Exit Sub
                End If
            End If
            ...
            End If
        Catch ex As Exception
            MsgBox("Errore durante il processo di ricerca, messaggio errore: " & ex.Message, MsgBoxStyle.Critical, "Asc Server - Errore Ricerca")
        End Try
    ...
    Public Sub SearchDTBPartenze()
        ...
        Try
            If ComboBox1.SelectedItem.ToString = "Ricerca Giornaliera" Then
                ...
                Try
                    For r = 1 To y
                        leggi = System.IO.File.OpenText(Application.StartupPath & "\Email\DATABASEPARTENZE\" & datadacercare & "\emailinviate" & r.ToString("D4") & "P.txt")
                        letto = leggi.ReadToEnd
                        leggi.Close()
                        If letto.Contains(TextBox1.Text) Then
                            DefinitiveSearchesString += vbCrLf & letto & vbCrLf
    ...
    Public Sub SearchDTBIntelligence()
        ...
        Try
            If ComboBox1.SelectedItem.ToString = "Ricerca Giornaliera" Then
                ...
                Try
                    For r = 1 To intell
                        leggi = System.IO.File.OpenText(Application.StartupPath & "\Email\INTELLIGENCE\" & datadacercare & "\emailinviate" & r.ToString("D4") & "INTEL.txt")
                        letto = leggi.ReadToEnd
                        leggi.Close()
                        If letto.Contains(TextBox1.Text) Then
                            DefinitiveSearchesString += vbCrLf & letto & vbCrLf
    ...
    Public Sub ShowMessageText()
        ...
        Try
            ...
            Else
                MsgBox("La ricerca non ha prodotto alcun risultato.", MsgBoxStyle.Information, "Asc Server - Ricerca")
                CheckBox1.Checked = False
                CheckBox2.Checked = False
                CheckBox3.Checked = False
            End If
