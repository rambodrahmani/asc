    ...
    Public Sub UseMessage()
        ...
        Try
            For Each cell In DataGridView1.SelectedCells
                ...
                leggi = System.IO.File.OpenText(Application.StartupPath & "\Email\INTELLIGENCE\" & datadefinitiva(0) & "\emailinviate" & (cell.RowIndex + 1).ToString("D4") & "INTEL.txt")
    ...
    Public Sub cercaemail()
        ...
        Try
            For Each cell In DataGridView1.SelectedCells
                ...
                My.Settings.OpenedFilePath = Application.StartupPath & "\Email\INTELLIGENCE\" & datadefinitiva(0) & "\emailinviate" & (cell.RowIndex + 1).ToString("D4") & "INTEL.txt"
                MessageText.Show()
            Next
        Catch ex As Exception
