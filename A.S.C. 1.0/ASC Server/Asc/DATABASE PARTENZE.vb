    ...
    Public Sub UseMessage()
        ...
        Try
            For Each cell In DataGridView1.SelectedCells
                ...
                leggi = System.IO.File.OpenText(Application.StartupPath & "\Email\DATABASEPARTENZE\" & datadefinitiva(0) & "\emailinviate" & (cell.RowIndex + 1).ToString("D3") & "P.txt")
    ...
    Public Sub cercaemail()
        ...
        Try
            For Each cell In DataGridView1.SelectedCells
                ...
                My.Settings.OpenedFilePath = Application.StartupPath & "\Email\DATABASEPARTENZE\" & datadefinitiva(0) & "\emailinviate" & (cell.RowIndex + 1).ToString("D3") & "P.txt"
                MessageText.Show()
            Next
        Catch ex As Exception
                ...
                If AlertMessage = 6 Then
                    ...
                    For Each cell In DataGridView1.SelectedCells
                        If cell.Value.ToString <> "" Then
                            System.IO.File.Delete(Application.StartupPath & "\Email\DATABASEPARTENZE\" & datagiorno & "\emailinviate" & (cell.RowIndex + 1).ToString("D3") & "A.txt")
                    ...
                    For r = 0 To DataGridView1.Rows.Count - 4
                        ...
                        stringadefinitiva += My.Settings.NumEmail2.ToString("D3") & "P - " & My.Settings.JlDate.ToString("D3") & "#"
                    ...
                    For z = 1 To UBound(FilesCollection2)
                        My.Computer.FileSystem.RenameFile(FilesCollection2(z), "emailinviate" & z.ToString("D3") & "P.txt")
                    Next
