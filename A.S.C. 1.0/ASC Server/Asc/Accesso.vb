Public Class Accesso
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If TextBox1.Text = "raffaele.tampano@alice.it" Then
                If TextBox2.Text = "sangiorgio" Then
                    ...
                    End If
                Else
                    MsgBox("Password Utente Errata", MsgBoxStyle.Information, "Asc - Acesso Uffici")
                End If
            Else
                MsgBox("Nome Utente Errato", MsgBoxStyle.Information, "Asc - Acesso Uffici")
            End If
